...
const blogPosts = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1715050222972-ac410ae190bc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHxwb3R0ZXJ5JTIwbWFraW5nJTIwdHJhZGl0aW9uYWwlMjBjcmFmdHxlbnwxfHx8fDE3NTczMjgyMTh8MA&ixlib=rb-4.1.0&q=80&w=400',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1689329662377-9b2b6774540a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHxzdXN0YWluYWJsZSUyMGVjbyUyMGZyaWVuZGx5JTIwY3JhZnRzfGVufDF8fHx8MTc1NzMyODIyMXww&ixlib=rb-4.1.0&q=80&w=400',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1593671186131-d58817e7dee0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHx3ZWF2aW5nJTIwdGV4dGlsZXMlMjB0cmFkaXRpb25hbCUyMGNyYWZ0c3xlbnwxfHx8fDE3NTczMjc5MjZ8MA&ixlib=rb-4.1.0&q=80&w=400',
    category: 'Textiles',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1722963295947-c6f8f1c50de2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoYW5kbWFkZSUyMGpld2VscnklMjBhcnRpc2FuJTIwd29ya3Nob3B8ZW58MXx8fHwxNzU3MzI3OTExfDA&ixlib=rb-4.1.0&q=80&w=400',
    category: 'Jewelry',
          ...
          {featuredPosts.map((post, index) => (
            ...
            >
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-background/80 to-muted/20 backdrop-blur-sm border border-border/50 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2">
                ...
                {/* Image */}
                <div className="aspect-[16/9] max-h-[250px] overflow-hidden">
                  <ImageWithFallback
                    src={post.image}
