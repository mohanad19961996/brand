        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div {...scaleIn} transition={{ ...scaleIn.transition, delay: 0.4 }}>
            <div className="relative">
              ...
              <div className="relative aspect-[4/3] max-h-[400px] rounded-2xl overflow-hidden bg-gradient-to-br from-muted/50 to-muted/20 backdrop-blur-sm border border-border/50">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1722963295947-c6f8f1c50de2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoYW5kbWFkZSUyMGpld2VscnklMjBhcnRpc2FuJTIwd29ya3Nob3B8ZW58MXx8fHwxNzU3MzI3OTExfDA&ixlib=rb-4.1.0&q=80&w=400"
