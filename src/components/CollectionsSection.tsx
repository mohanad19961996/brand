...
const collections = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1593671186131-d58817e7dee0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHx3ZWF2aW5nJTIwdGV4dGlsZXMlMjB0cmFkaXRpb25hbCUyMGNyYWZ0c3xlbnwxfHx8fDE3NTczMjc5MjZ8MA&ixlib=rb-4.1.0&q=80&w=300',
    productCount: 93,
    featured: false,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {collections.map((collection, index) => (
            ...
            >
              <div className="relative aspect-[4/3] max-h-[300px] overflow-hidden bg-gradient-to-br from-muted/50 to-muted/20 backdrop-blur-sm border border-border/50 rounded-2xl transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2">
                {/* Background Image */}
                <ImageWithFallback
